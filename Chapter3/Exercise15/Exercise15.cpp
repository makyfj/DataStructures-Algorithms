 ...
 * Cuckoo Hashing
 *
 * Cuckoo hashing to create a hash table and insert various elements in it. We
 * shall also get a trace of how the operation proceeds, which will allow us to
 * take a look at how insertion works.
 */
#include <iostream>
#include <vector>
...
public:
  hash_map(int n) : size(n) {
    ...
    // Initialize data tables as empty(indicated by -1)
